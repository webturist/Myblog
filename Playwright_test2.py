...
def run(playwright: Playwright) -> None:
    ...
    try:
        ...
        sys.stderr.write('Test passed: the title page is displayed correctly\n')
    except:
        sys.stderr.write(f'Error: the title page not displayed correctly\n')
    ...
    page.locator("div").filter(
        has_text="Welcome to FlaskBlog").get_by_role("link", name="New Post").first.click()
