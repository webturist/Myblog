...
class AppTest(unittest.TestCase):
    ...
    def test_1_register_and_login(self):
        ...
        self.assertIn('You have successfully registered!', welcome_message.text)
    ...
    def test_2_create_post(self):
        ...
        success_message = WebDriverWait(self.driver, 10).until(
            EC.presence_of_element_located((By.XPATH, "//h2[contains(text(), 'New Post')]"))
        )
    ...
    def test_3_edit_post(self):
        ...
        edit_post_link = self.driver.find_element(By.XPATH, f"//a[@href='/{post_id}/edit']")
        ...
        success_message = WebDriverWait(self.driver, 10).until(
            EC.presence_of_element_located((By.XPATH, "//div[contains(text(), 'Post updated successfully')]"))
        )
    ...
    def test_4_add_comment(self):
        ...
        post_link = self.driver.find_element(By.XPATH, f"//a[@href='/{post_id}']")
        post_link.click()
        ...
        success_message = WebDriverWait(self.driver, 10).until(
            EC.presence_of_element_located((By.XPATH, "//div[contains(text(), 'Comment added successfully')]"))
        )
        ...
        post_title = WebDriverWait(self.driver, 10).until(
            EC.presence_of_element_located((By.XPATH, f"//h2[contains(text(), 'Post')]"))
        )
        ...
        comment_text_element = WebDriverWait(self.driver, 10).until(
            EC.presence_of_element_located((By.XPATH, f"//p[contains(text(), '{comment_text}')]"))
        )
    ...
    def test_5_delete_post(self):
        ...
        delete_post_button = self.driver.find_element(By.XPATH, "//input[@value='Delete Post']")
        ...
        success_message = WebDriverWait(self.driver, 10).until(
            EC.presence_of_element_located((By.XPATH, "//div[contains(text(), 'was successfully deleted!')]"))
        )
